...
public class AssignHandler {
    ...
    public String saveAdminRoleRelationship(
            @RequestParam("adminId") Integer accountId,
        ...
        adminService.saveAdminRoleRelationship(accountId, roleIdList);
    ...
    public ResultEntity<List<Authority>> getAllAuth() {

        List<Authority> authList = authService.getAll();
